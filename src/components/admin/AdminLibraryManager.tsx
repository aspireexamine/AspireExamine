...
export function AdminLibraryManager({ notebookFolders, setNotebookFolders }: AdminLibraryManagerProps) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage notebook folders and library items for students</p>
        </div>
        <Button onClick={() => handleOpenFolderDialog('create')} className="gap-2">
              ...
              <AccordionTrigger className="p-3 sm:p-4 bg-muted/50 hover:no-underline hover:bg-muted/80">
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">({folder.notebooks.length} items)</span>
                  </div>
