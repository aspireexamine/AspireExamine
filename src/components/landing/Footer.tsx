...
const Footer: React.FC<FooterProps> = ({ onGetStarted }) => {
  ...
  return (
    <footer className="bg-cream pt-8 sm:pt-10 pb-8 sm:pb-10 border-t border-gray-100">
      
      {/* CTA Box */}
      <div className="container mx-auto px-4 sm:px-6 md:px-12 mb-8 sm:mb-12 md:mb-20 relative z-10 -mt-16 sm:-mt-20 md:-mt-24 lg:-mt-32">
        <div className="bg-gradient-to-r from-[#DCCBFF] to-[#FFDBEB] rounded-[24px] sm:rounded-[30px] md:rounded-[40px] p-6 sm:p-8 md:p-20 text-center shadow-lg relative overflow-hidden">
           ...
           <h2 className="text-xl sm:text-2xl md:text-4xl font-heading font-bold text-white mb-4 sm:mb-6 md:mb-8 drop-shadow-sm leading-tight">
             READY TO ACE YOUR EXAMS? <br className="hidden md:block"/> START YOUR JOURNEY TODAY
           </h2>
           <div className="inline-block bg-white p-1 rounded-full w-full sm:w-auto">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-12 mb-6 sm:mb-8 md:mb-16">
